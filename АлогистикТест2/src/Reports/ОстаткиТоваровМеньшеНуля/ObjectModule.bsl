...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	ОтчетыУНФ.ДобавитьВариантРасшифровки(НастройкиВариантов["ОстаткиТоваровМеньшеНуля"].ВариантыРасшифровки, "Отчет.ДвижениеТоваров", "ДвижениеТоваров");
	
	ЗаполнитьПредопределенныеВариантыОформления(НастройкиВариантов);
	ДобавитьОписанияСвязанныхПолей(НастройкиВариантов);
	
	НастройкиВариантов["ОстаткиТоваровМеньшеНуля"].Теги = НСТР("ru = 'Главное,Товары,Запасы,Продажи,Закупки,Номенклатура'");
	НастройкиВариантов["ОстаткиТоваровМеньшеНуля"].Рекомендуемый = Истина;
	НастройкиВариантов["ОстаткиТоваровМеньшеНуля"].Вставить("РежимПериода", "НаДату");
...
Процедура ОбновитьНастройкиНаФорме(НастройкиОтчета, НастройкиСКД, Форма) Экспорт
	...
	Для каждого ОписаниеРеквизита Из СтрВидЦен.Реквизиты Цикл
		...
		Если НЕ Элемент=Неопределено Тогда
			...
			Элемент.ПодсказкаВвода = НСтр("ru = 'Вид цен'");
...
Процедура ЗаполнитьПредопределенныеВариантыОформления(НастройкиВариантов)
	...
	МассивПолейКоличеств = СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивПодстрок("Количество,СвободныйОстаток,КоличествоНаТекущуюДату"); 
