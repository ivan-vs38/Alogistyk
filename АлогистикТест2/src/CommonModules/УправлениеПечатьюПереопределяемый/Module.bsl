...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	СписокОбъектов.Добавить(Документы.алк_ТранспортировкаЗапасов);
	СписокОбъектов.Добавить(Документы.алк_ПеремещениеЗапасов);
	СписокОбъектов.Добавить(Документы.алк_СменныйРапортЦЛП);
	СписокОбъектов.Добавить(Документы.алк_ПриемкаЛесопродукции);
	СписокОбъектов.Добавить(Документы.алк_ВнутренняяПередачаМеждуОрганизациями);
	СписокОбъектов.Добавить(Документы.алк_ОтгрузкаЩепы);
	СписокОбъектов.Добавить(Документы.алк_ТранспортировочныеПартии);
	СписокОбъектов.Добавить(Документы.алк_ЗаявкаФСС);
	СписокОбъектов.Добавить(Документы.алк_ПеремещениеЛесопродукции);
	СписокОбъектов.Добавить(Документы.алк_ИнвентаризацияПоСериям);
	СписокОбъектов.Добавить(Документы.рфп_ОтгрузкаВагона);
	СписокОбъектов.Добавить(Документы.алк_РасформированиеПакетов);
	СписокОбъектов.Добавить(Документы.алк_СборкаЗапасов); 
	СписокОбъектов.Добавить(Документы.алк_Перемещение);
	СписокОбъектов.Добавить(Документы.алк_Инвентаризация);
	СписокОбъектов.Добавить(Документы.алк_ДокладнаяОТК);	
	//рфп 
