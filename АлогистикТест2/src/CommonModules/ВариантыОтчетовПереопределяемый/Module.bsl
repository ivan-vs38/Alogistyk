...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	Разделы.Добавить(Метаданные.Подсистемы.алк_СводнаяАналитика, НСтр("ru = 'Сводная аналитика'"));
	Разделы.Добавить(Метаданные.Подсистемы.алк_ПроизводствоЦЛП, НСтр("ru = 'Производство ЦЛП'"));
	Разделы.Добавить(Метаданные.Подсистемы.алк_ЛесобиржаЦЛП, НСтр("ru = 'Лесобиржа ЦЛП'"));
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ВедомостьТоварыНаСкладах, "Основной");
	Вариант.Описание = НСтр("ru = 'Остатки и обороты запасов по складам.'");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ВедомостьТоварыОрганизации1, "Основной");
	Вариант.Описание = НСтр("ru = 'Остатки и обороты запасов на участке сортированных ЛМ.'");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_РасширеннаяВедомостьТоварыОрганизации, "Основной");
	Вариант.Описание = НСтр("ru = 'Остатки и обороты запасов на участках.'");

	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ТоварыНаСкладахРезерв, "Основной");
	Вариант.Описание = НСтр("ru = 'Остатки запасов по складам.'");

	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ТоварыНаСкладахПоПараметрам, "Основной");
	Вариант.Описание = НСтр("ru = 'Запасы на складах.'");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ВыпускПродукции, "Основной");
	Вариант.Описание = НСтр("ru = 'Производство продукции.'");

	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ВыпускПродукцииДопАналитика, "Основной");
	Вариант.Описание = НСтр("ru = 'Производство продукции (упакованной и нет).'");	
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ЗатратыМатериаловНаВыпуск, "Основной");
	Вариант.Описание = НСтр("ru = 'Затраты материалов на выпуск.'");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ВыполнениеЗаказов, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет по выполнению заказов.'");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ТоварыКПоступлениюНаСклад, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет по товарам, готовым к передаче на склад.'");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_АналитикаВыполненияЗаказов, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет анализ выполнения заказов (Производство).'");

	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ПриемкаЛесопродукцииПоДокументам, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет анализ документов приемки лесопродукции.'");

	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ПриемкаЛесопродукцииГОСТ, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет приемка лесопродукции ""Биржа ЦЛП"" (по ГОСТу)'");

	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ПриемкаЛесопродукцииГОСТ_ДопДанныеПоставщика, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет приемка лесопродукции ""Биржа ЦЛП"" с данными поставщика (по ГОСТу)");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ВнутренняяПередачаМеждуОрганизациями, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет передача на ""Торговый дом"".");

	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ПриемкаЛесопродукцииГОСТ_Топ, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет приемка лесопродукции ""Биржа ЦЛП"" (по ГОСТу)");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ВедомостьУчастокСортированныхЛМ_2, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет: Ведомость ""Биржа ЦЛП"" (участок сортированных ЛМ)");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ВедомостьТоварыНаСкладах_Вертикальная, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет: Ведомость ""Склад готовой продукции"" (вертикальная)");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ВедомостьУчастокПереупакаовкиСГП_Вертикальная, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет: Ведомость ""Участок переупаковки СГП"" (вертикальная)");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_АналитическийОтчет_ПроизводственнаяИнформация, "Основной");
	Вариант.Описание = НСтр("ru = 'Аналитический отчет по участку производства ЦЛП)");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_АналитическийОтчет_ПоказателиРапортов, "Основной");
	Вариант.Описание = НСтр("ru = 'Аналитический отчет по участку производства ЦЛП)");

	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ПриемкаБиржаЦЛПпоГОСТ, "Основной");
	Вариант.Описание = НСтр("ru = 'Приемка лесопродукции на биржу ЦЛП");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ОстаткиУчастокПереупакаовкиСГП, "Основной");
	Вариант.Описание = НСтр("ru = 'Остатки по участку переупаковки СГП");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_АналитическийОтчет_РасчетныйВыходЦЛП, "Основной");
	Вариант.Описание = НСтр("ru = 'Аналитический отчет по участку производства ЦЛП)");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_УчастокСортированныхЛМ_ВедомостьВертикальная, "Основной");
	Вариант.Описание = НСтр("ru = 'Ведомость(вертикальная) по участку сортированных ЛМ");

	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ПоступлениеПиломатериаловНаСГП, "Основной");
	Вариант.Описание = НСтр("ru = 'Поступление пиломатериалов на СГП за период");

	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ПоступлениеОтходовНаСГП, "Основной");
	Вариант.Описание = НСтр("ru = 'Поступление отходов на СГП за период");

	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ОгрузкаПродукции, "Основной");
	Вариант.Описание = НСтр("ru = 'Отгрузки готовой продукции за период");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ВедомостьУчетаЛесопродукцииНаОтветхранении, "Основной");
	Вариант.Описание = НСтр("ru = 'Учет лесопродукции не ответхранении");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_Отходы_ВедомостьВертикальная, "Основной");
	Вариант.Описание = НСтр("ru = 'Ведомость по щеповым отходам");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ОстаткиТоварыНаВнешихСкладах, "Основной");
	Вариант.Описание = НСтр("ru = 'Остатки товаров на ""внешних"" складах");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ВыполнениеЗаказовКонсолидированный, "Основной");
	Вариант.Описание = НСтр("ru = 'Консолидированный отчет по выполнению заказов");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_СоответствиеПриемка_ПередачаОХ, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет по соответствию между приемкой лесопродукции и передачей на ответхранение");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_Топ_ОстаткиТоварыНаСГП_Пилмат, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет по остаткам упакованных пиломатериалов на СГП");

	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_Топ_ОстаткиТоварыНаСГП_Отходы, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет по остаткам упакованных отходов на СГП");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ПоступлениеУСЛМ, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет по поступлению пиловочника на биржу ЦЛП");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ПоступлениеУСЛМ_ОУБУ, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет по поступлению пиловочника на биржу ЦЛП (+ГОСТ)");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_БуферныйСкладЦЛП_ВедомостьВертикальная, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет ведомость вертикальная по буферному складу ЦЛП");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ВыпускПродукцииДопАналитика_2, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет по производству ПМ (процентный выход центральной доски)");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.алк_ОтчетПоСкладу, "ОтчетПоСкладу");
	Вариант.Описание = НСтр("ru = 'Отчет по складу");
