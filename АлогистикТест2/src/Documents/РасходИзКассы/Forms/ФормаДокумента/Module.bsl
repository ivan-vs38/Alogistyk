...
Процедура ДополнитьТоварамиПараметрыПриПробитииЧека(ДокументОбъект, ОбщиеПараметры)
	...
	Если ЗначениеЗаполнено(ДокументОбъект.ДокументОснование) 
		И (ТипЗнч(ДокументОбъект.ДокументОснование) = Тип("ДокументСсылка.ПриходнаяНакладная")
		ИЛИ ТипЗнч(ДокументОбъект.ДокументОснование) = Тип("ДокументСсылка.ЗаказПоставщику")
		ИЛИ ТипЗнч(ДокументОбъект.ДокументОснование) = Тип("ДокументСсылка.СчетНаОплатуПоставщика")
		ИЛИ ТипЗнч(ДокументОбъект.ДокументОснование) = Тип("ДокументСсылка.ДополнительныеРасходы")) Тогда
		...
		Если ДокументОбъект.ВалютаДенежныхСредств = СтруктураРеквизитов.ВалютаДокумента
			...
			Если ТипЗнч(ДокументОбъект.ДокументОснование) = Тип("ДокументСсылка.ДополнительныеРасходы") Тогда
				ДополнитьТоварамиПоДокументу(ДокументОбъект.ДокументОснование, ОбщиеПараметры, "Расходы");
			Иначе
...
Процедура ДополнитьТоварамиПоТаблицеДокумента(ДокументОбъект, ОбщиеПараметры)
	...
	Если ТабличнаяЧасть.Количество() = 1 
		...
		И (ТипЗнч(ТабличнаяЧасть[0].Документ) = Тип("ДокументСсылка.ПриходнаяНакладная")
		ИЛИ ТипЗнч(ТабличнаяЧасть[0].Документ) = Тип("ДокументСсылка.ДополнительныеРасходы"))
		...
		Если ТипЗнч(ТабличнаяЧасть[0].Документ) = Тип("ДокументСсылка.ДополнительныеРасходы") Тогда
			ДополнитьТоварамиПоДокументу(ТабличнаяЧасть[0].Документ, ОбщиеПараметры, "Расходы");
		Иначе
	...
	ИначеЕсли ТабличнаяЧасть.Количество() = 1 
		...
		И ТипЗнч(ТабличнаяЧасть[0].Заказ) = Тип("ДокументСсылка.ЗаказПоставщику")
		И ТабличнаяЧасть[0].СуммаПлатежа = ДокументОбъект.СуммаДокумента
...
Процедура ДополнитьТоварамиПоДокументу(ДокументОбъект, ОбщиеПараметры, ТабличнаяЧасть = "Запасы")
	...
	Для каждого СтрокаТЧ Из ДокументОбъект[ТабличнаяЧасть] Цикл
		...
		Если ТабличнаяЧасть = "Расходы" Тогда
