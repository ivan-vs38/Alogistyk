...
Процедура ОбработатьИзменениеВидаОперации(ИзменениеОперации = Истина)
	...
	Иначе
		...
		Объект.ОнЖе = НЕ ЗначениеЗаполнено(Объект.Грузоотправитель);
...
Функция ОбновитьПодвалФормы()
	...
	СтоимостьДоставкиСНДС = Объект.СтоимостьДоставкиБезНДС + Объект.СуммаНДСДоставки;
...
Процедура ОбновитьСуммуНДСДоставки()
	...
	Объект.СуммаНДСДоставки = Объект.СтоимостьДоставкиБезНДС * СтавкаНДСДоставки / 100;
	СтоимостьДоставкиСНДС = Объект.СтоимостьДоставкиБезНДС + Объект.СуммаНДСДоставки;
