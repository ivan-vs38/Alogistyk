...
Функция СформироватьПечатнуюФормуТоварногоЧека(МассивОбъектов, ОбъектыПечати)
	...
	Для каждого ЧекККМ Из МассивОбъектов Цикл
		...
		|	ЧекККМВозврат.ПодписьЗаведущегоОтделом.Должность КАК ДолжностьЗаведущегоОтделом,
		|	ЧекККМВозврат.ПодписьЗаведущегоОтделом.РасшифровкаПодписи КАК РасшифровкаПодписиЗаведущегоОтделом,
...
Функция СформироватьПечатнуюФормуКМ3(МассивОбъектов, ОбъектыПечати)
	...
	Для Каждого ЧекККМВозврат ИЗ МассивОбъектов Цикл
		...
		|	ДокЧек.ПодписьЗаведущегоОтделом.Должность КАК ДолжностьЗаведущегоОтделом,
		|	ДокЧек.ПодписьЗаведущегоОтделом.РасшифровкаПодписи КАК РасшифровкаПодписиЗаведущегоОтделом,
