...
Функция СформироватьПечатнуюФормуКМ6(МассивОбъектов, ОбъектыПечати)
	...
	Для каждого ОтчетОРозничныхПродажах Из МассивОбъектов Цикл
		...
		|	ОтчетОРозничныхПродажах.ПодписьЗаведущегоОтделом.Должность КАК ДолжностьЗаведущегоОтделом,
		|	ОтчетОРозничныхПродажах.ПодписьЗаведущегоОтделом.РасшифровкаПодписи КАК РасшифровкаПодписиЗаведущегоОтделом,
		...
		|	ОтчетОРозничныхПродажах.ПодписьЗаведущегоОтделом.Должность,
		|	ОтчетОРозничныхПродажах.ПодписьЗаведущегоОтделом.РасшифровкаПодписи,
		...
		ДанныеПечати.Вставить("ОрганизацияПредставление", УправлениеНебольшойФирмойСервер.ОписаниеОрганизации(СведенияОПокупателе, "ПолноеНаименование,ЮридическийАдрес,Телефоны,"));
		...
		ДанныеПечати.Вставить("РасшифровкаПодписиЗаведущегоОтделом", Продажи.РасшифровкаПодписиЗаведущегоОтделом);
...
Функция СформироватьПечатнуюФормуКМ3(МассивОбъектов, ОбъектыПечати)
	...
	|	,ОтчетПоРознице.ПодписьЗаведущегоОтделом.Должность КАК ДолжностьЗаведущегоОтделом
	|	,ОтчетПоРознице.ПодписьЗаведущегоОтделом.РасшифровкаПодписи КАК РасшифровкаПодписиЗаведущегоОтделом
	...
	|	,Неопределено КАК СерийныйНомерККМ
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ВыборкаПоЧекамИтоги.НайтиСледующий(Новый Структура("ОтчетОРозничныхПродажах", Выборка.Ссылка)) Тогда
			...
			ОбластьПодвала.Параметры.РасшифровкаПодписиЗаведущегоОтделом = Выборка.РасшифровкаПодписиЗаведущегоОтделом;
