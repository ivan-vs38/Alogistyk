...
Процедура ЗаполнитьПоПриходнаяНакладная(ДокументСсылкаПриходнаяНакладная) Экспорт
	...
	Если ТипЗнч(Выборка.ДокументОснованиеПриходнойНакладной) = Тип("ДокументСсылка.ЧекККМ")
		...
		Если Выборка.ДокументОснованиеПриходнойНакладной.ОплатаПлатежнымиКартами.Количество() > 0 Тогда
			ЭквайринговыйТерминал = Выборка.ДокументОснованиеПриходнойНакладной.ЭквайринговыйТерминал;
			БанковскийСчет = ЭквайринговыйТерминал.БанковскийСчетЭквайринг;
			ВидПлатежнойКарты = Выборка.ДокументОснованиеПриходнойНакладной.ОплатаПлатежнымиКартами[0].ВидПлатежнойКарты;
			НомерПлатежнойКарты = Выборка.ДокументОснованиеПриходнойНакладной.ОплатаПлатежнымиКартами[0].НомерПлатежнойКарты;
		КонецЕсли;
	КонецЕсли;
