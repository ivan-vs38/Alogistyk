...
// Таблицы значений сохраняет в свойствах структуры "ДополнительныеСвойства".
//
Процедура СформироватьТаблицаРасчетыСПокупателямиВозврат(ДокументСсылкаОперацияПоПлатежнымКартам, СтруктураДополнительныеСвойства)
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаОперацияПоПлатежнымКартам, СтруктураДополнительныеСвойства) Экспорт
	...
	Иначе
		СформироватьТаблицаРасчетыСПокупателямиВозврат(ДокументСсылкаОперацияПоПлатежнымКартам, СтруктураДополнительныеСвойства);
	КонецЕсли;
