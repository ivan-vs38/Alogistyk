...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_ШаблоныПечатиОфисныхДокументов" И НЕ ЗначениеЗаполнено(Элементы.ПодменюКоммерческоеПредложение.Картинка) Тогда
		Элементы.ПодменюКоммерческоеПредложение.Картинка = БиблиотекаКартинок.ВосклицательныйЗнакКрасный;
		Элементы.ПодменюКоммерческоеПредложение.Заголовок = Элементы.ПодменюКоммерческоеПредложение.Заголовок + НСтр("ru=' (требуется переоткрыть форму)'");
	КонецЕсли;
