...
// Таблицы значений сохраняет в свойствах структуры "ДополнительныеСвойства".
//
Процедура СформироватьТаблицаЗакупкиДляКУДиР(ДокументСсылкаКорректировкаПоступления, СтруктураДополнительныеСвойства)
	...
	ВалютаДокумента = ДокументСсылкаКорректировкаПоступления.ВалютаДокумента;
	
	Если УчетВалюты И ВалютаДокумента <> НацВалюта Тогда
		ТекущийКурс = РаботаСКурсамиВалют.ПолучитьКурсВалюты(ВалютаДокумента, ДокументСсылкаКорректировкаПоступления.Дата);
