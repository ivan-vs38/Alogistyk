...
Процедура УстановитьВидимостьИДоступность()
	...
	Элементы.КонтекстноеМенюОплатаПлатежнымиКартамиДобавитьОплатуКартой.Видимость = ЗначениеЗаполнено(ЭквайринговыйТерминал);
	Элементы.КонтекстноеМенюОплатаПлатежнымиКартамиНапечататьСлипЧекОперации.Видимость = ЗначениеЗаполнено(ЭквайринговыйТерминал);
	Элементы.КонтекстноеМенюОплатаПлатежнымиКартамиУдалитьОплатуКартой.Видимость = ЗначениеЗаполнено(ЭквайринговыйТерминал);
	
	Элементы.КонтекстноеМенюОплатаПлатежнымиКартамиДобавить.Видимость = НЕ ЗначениеЗаполнено(ЭквайринговыйТерминал);
	Элементы.КонтекстноеМенюОплатаПлатежнымиКартамиСкопировать.Видимость = НЕ ЗначениеЗаполнено(ЭквайринговыйТерминал);
	Элементы.КонтекстноеМенюОплатаПлатежнымиКартамиУдалить.Видимость = НЕ ЗначениеЗаполнено(ЭквайринговыйТерминал);
...
Процедура СтруктурнаяЕдиницаПриИзменении(Элемент)
	...
	СтруктураДанных = ПолучитьДеталиПодразделения(Объект.СтруктурнаяЕдиница);
