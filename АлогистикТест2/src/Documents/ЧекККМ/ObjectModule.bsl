...
Процедура ЗаполнитьПоЗаказуПокупателя(ДанныеЗаполнения) Экспорт
	...
	Если ТаблицаОстатков.Количество() > 0 Тогда
		...
		Пока Выборка.Следующий() Цикл
			...
			Если Выборка.МаркируемыйПродукция = Истина Тогда
	...
	Если ЕстьМаркируемыйПродукция Тогда
		...
		Сообщение.Текст = "В заказе присутствует маркируемая алкогольная продукция. Ее необходимо добавить в чек вручную.";
		Сообщение.Сообщить();
	КонецЕсли;
