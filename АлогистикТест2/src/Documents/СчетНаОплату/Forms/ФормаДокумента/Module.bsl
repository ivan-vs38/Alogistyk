...
Процедура ДекорацияПечатьНажатие(Элемент)
	...
	ОткрытьФорму("Обработка.РеквизитыПечати.Форма.РеквизитыПечатиСчетНаОплату", Новый Структура("КонтекстПечати", Объект), ЭтотОбъект, , , , ОписаниеОповещения);
...
Функция ПолучитьДанныеОрганизацияПриИзменении()
	...
	СтруктураДанные.Вставить("ИспользоватьФаксимиле", ПодписьДокументовУНФ.НадоВключитьФаксимиле(Объект.Организация, "СчетНаОплату"));
