...
#Если Сервер Или ТолстыйКлиентОбычноеПриложение Или ВнешнееСоединение Тогда
	...
	Процедура ОбработкаПроведения(Отказ, РежимПроведения)
		...
		Документы.алк_ВозвратОтветхранения.ИнициализироватьДанныеДокумента(Ссылка, ДополнительныеСвойства);
		...
		Если ВидДокумента = Перечисления.алк_ВидыДокументовВозвратОтветхранения.Оприходование Тогда
		...
		ОтказПоКонтролю = РфпСервер.КонтрольОтрицательныхостатковПоРегистру(РежимПроведения, ДополнительныеСвойства, "алк_УчетЛесопродукцииНаОтветхранении");
