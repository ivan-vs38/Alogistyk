...
Функция ДанноеСообщениеДоступноДляИП(Вид)
	...
	Если Вид = ПредопределенноеЗначение("Перечисление.ВидыУведомленийОСпецрежимахНалогообложения.ЗаявлениеНаПолучениеПатентаРекомендованнаяФорма")
		...
		Или Вид = ПредопределенноеЗначение("Перечисление.ВидыУведомленийОСпецрежимахНалогообложения.ФормаКИК") Тогда
...
Процедура СформироватьДерево()
	...
	ДобавитьВеткуВДеревоУведомлений(КорневойУровень, Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ФормаКИК);
