...
Функция СохранитьНастройки()
	...
	Если ИспользоватьВнешнийМодуль И НЕ ОбщегоНазначенияПовтИсп.РазделениеВключено() И НЕ ЗначениеЗаполнено(ДанныеМодуля) Тогда
...
Процедура УправлениеЭУВРежимеСервиса()
	...
	Элементы.ГруппаВнешнийМодульВРежимеСервиса.Видимость = ОбщегоНазначенияПовтИсп.РазделениеВключено() И ИспользоватьВнешнийМодуль;
