...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонецЕсли;
	ВыводитьГруппуЗагрузкиИГруппуВыгрузки = Истина; //Параметры.Свойство("ФормаВыгрузка") И Параметры.Свойство("ФормаЗагрузка");
	//Элементы.РезделительЗначенияДляВыгружаемыхСправа.Видимость = ВыводитьГруппуЗагрузкиИГруппуВыгрузки;
	//Элементы.РезделительЗначенияДляЗагружаемыхСлева.Видимость = ВыводитьГруппуЗагрузкиИГруппуВыгрузки;
	Элементы.ЗначенияДляЗагружаемых.ОтображатьЗаголовок = Параметры.Свойство("ФормаЗагрузка"); //ВыводитьГруппуЗагрузкиИГруппуВыгрузки;
	Элементы.ЗначенияДляВыгружаемых.ОтображатьЗаголовок = Параметры.Свойство("ФормаВыгрузка"); //ВыводитьГруппуЗагрузкиИГруппуВыгрузки;
	...
	Если Параметры.Свойство("ЗагруженыНастройкиСчета") И Параметры.ЗагруженыНастройкиСчета Тогда
		...
		// Если обработка загрузки была вызвана из списка документа, то кодировка используется общая.
		Если Параметры.Свойство("НастройкиОбщиеПолучены") И Параметры.НастройкиОбщиеПолучены Тогда
			//Элементы.ГруппаКодировка.Видимость = Ложь;
		КонецЕсли;
	Иначе
...
Процедура ОткрытьСправочникСоответствийНазначенийПлатежаИРеквизитовДокументов(Команда)
	...
	ОткрытьФорму("Справочник.СоответствияНазначенийПлатежаИРеквизитовПлатежа.ФормаСписка",,,,,,,РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура ОткрытьСписокПоследнихВыбранныхЗначений(Команда)
	...
	ОткрытьФорму("РегистрСведений.ИсторияЗначенийРеквизитовПриЗагрузкеИзКлиентаБанка.ФормаСписка",,,,,,,РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
