...
Процедура СоздатьЭлементыДиаграммы()
	...
	Для каждого Стр Из ДобавленныеДиаграммы Цикл
		...
		Если ПустаяСтрока(Стр.ИмяГруппы) Тогда
			...
			ДобавитьКоманду(Стр.ИмяГруппы, "_Настроить", ЭлементЗаголовок, "КонтекстНастроитьДиаграмму", НСтр("ru = 'Настроить график'"), БиблиотекаКартинок.ХранилищеНастроек);
			ДобавитьКоманду(Стр.ИмяГруппы, "_Удалить", ЭлементЗаголовок, "КонтекстУдалитьДиаграмму", НСтр("ru = 'Удалить график'"), БиблиотекаКартинок.Удалить);
			ДобавитьКоманду(Стр.ИмяГруппы, "_Вверх", ЭлементЗаголовок, "КонтекстСместитьВверхДиаграмму", НСтр("ru = 'Сместить вверх'"), БиблиотекаКартинок.ПереместитьВверх);
			ДобавитьКоманду(Стр.ИмяГруппы, "_Вниз", ЭлементЗаголовок, "КонтекстСместитьВнизДиаграмму", НСтр("ru = 'Сместить вниз'"), БиблиотекаКартинок.ПереместитьВниз);
