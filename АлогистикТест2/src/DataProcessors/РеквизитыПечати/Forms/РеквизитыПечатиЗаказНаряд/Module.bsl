...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(КонтекстПечати, Параметры.КонтекстПечати, "Организация, ВалютаДокумента, СтруктурнаяЕдиницаРезерв, Грузоотправитель, Контрагент, Договор, Грузополучатель, АдресДоставки, ДоверенностьВыдана, ДоверенностьДата, ДоверенностьЛицо, ДоверенностьНомер, ОснованиеПечати, ОснованиеПечатиСсылка, ПодписьРуководителя, ПодписьГлавногоБухгалтера, ПодписьКладовщика, КонтактноеЛицоПодписант, БанковскийСчет, БанковскийСчетКонтрагента, УсловияСчетаЗаказа, УсловияГарантийногоТалона, ДокументОснование, ИспользоватьФаксимиле");
