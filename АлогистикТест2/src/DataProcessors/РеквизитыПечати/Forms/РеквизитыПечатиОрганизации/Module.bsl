...
Процедура ДобавитьИзображениеНаКлиентеФрагмент()
	...
	ИначеЕсли ЗначениеЗаполнено(КонтекстПечати.Ссылка) Тогда
		...
		ПрисоединенныеФайлыКлиент.ДобавитьФайлы(КонтекстПечати.Ссылка, ИдентификаторФайла, Фильтр);
...
Процедура ДобавитьИзображениеФаксимилеФрагмент()
	...
	ИдентификаторФайла = Новый УникальныйИдентификатор;
	ПрисоединенныеФайлыКлиент.ДобавитьФайлы(ОрганизацияСсылка, ИдентификаторФайла);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_ПрисоединенныйФайл" Тогда
		...
		Если КэшЗначений.РаботаСЛоготипом Тогда
			...
			ДвоичныеДанныеКартинки = УправлениеНебольшойФирмойСервер.СсылкаНаДвоичныеДанныеФайла(КонтекстПечати.ФайлЛоготип, УникальныйИдентификатор);
		...
		ИначеЕсли КэшЗначений.РаботаСФаксимиле Тогда
			...
			ДвоичныеДанныеКартинки = УправлениеНебольшойФирмойСервер.СсылкаНаДвоичныеДанныеФайла(КонтекстПечати.ФайлФаксимильнаяПечать, УникальныйИдентификатор);
			Если ДвоичныеДанныеКартинки <> Неопределено Тогда 
...
Процедура ИспользованиеФаксимилеНажатие(Элемент)
	...
	ОткрытьФорму("РегистрСведений.ФаксимилеНастройки.ФормаСписка");
...
Процедура ИзменитьИзображениеЛоготипа(Команда)
	...
	Если ЗначениеЗаполнено(КонтекстПечати.ФайлЛоготип) Тогда
		...
		ПрисоединенныеФайлыКлиент.ОткрытьФормуПрисоединенногоФайла(КонтекстПечати.ФайлЛоготип);
...
Процедура ИзменитьИзображениеФаксимиле(Команда)
	...
	Если ЗначениеЗаполнено(КонтекстПечати.ФайлФаксимильнаяПечать) Тогда
		...
		ПрисоединенныеФайлыКлиент.ОткрытьФормуПрисоединенногоФайла(КонтекстПечати.ФайлФаксимильнаяПечать);
