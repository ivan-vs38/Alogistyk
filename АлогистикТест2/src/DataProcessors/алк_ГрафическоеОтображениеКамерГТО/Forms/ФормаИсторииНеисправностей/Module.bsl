...
Процедура РедактироватьНаКлиенте()
	...
	ОткрытьФорму("Обработка.алк_ГрафическоеОтображениеКамерГТО.Форма.ФормаРедактированияСостоянияКамеры",ПараметрыФормы, ЭтаФорма,,,,Новый ОписаниеОповещения("ПриЗакрытииФормыРедактиррованияОбновитьИсториюСостояний",ЭтаФорма), РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
КонецПроцедуры
