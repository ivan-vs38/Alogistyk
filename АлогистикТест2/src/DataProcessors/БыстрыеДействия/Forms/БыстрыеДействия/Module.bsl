...
Процедура Инициализация(Отказ)
	...
	ДоступныЗакупки = (РольДоступна("ДобавлениеИзменениеПодсистемыЗакупки") ИЛИ ПолныеПрава);
	ДоступнаКасса = (РольДоступна("ДобавлениеИзменениеПодсистемыКасса") ИЛИ ПолныеПрава);
	ДоступноДобавлениеТоваров = (РольДоступна("ДобавлениеИзменениеНоменклатуры") ИЛИ ПолныеПрава);
	
	Если ПолучитьФункциональнуюОпцию("УчетРозничныхПродаж") И ДоступныПродажи Тогда
	...
	ОпределитьНаличиеВводовОстатков();
