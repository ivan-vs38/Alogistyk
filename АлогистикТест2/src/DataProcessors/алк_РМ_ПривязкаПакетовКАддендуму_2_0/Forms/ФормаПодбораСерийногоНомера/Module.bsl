...
Процедура УстановитьПараметрыОтбораСервер()  
	...
	Список.Параметры.УстановитьЗначениеПараметра("СтруктурнаяЕдиница", СтруктурнаяЕдиница.ВыгрузитьЗначения());
	Список.Параметры.УстановитьЗначениеПараметра("Штабель", Штабель.ВыгрузитьЗначения());
	Список.Параметры.УстановитьЗначениеПараметра("ТекущийАддендум", Аддендум.ВыгрузитьЗначения());
	...
	Если СтруктурнаяЕдиница.Количество()>0 Тогда 
		Список.Параметры.УстановитьЗначениеПараметра("ВсеСтруктурнаяЕдиница", Ложь);
	Иначе
		Список.Параметры.УстановитьЗначениеПараметра("ВсеСтруктурнаяЕдиница", Истина);
	КонецЕсли;
	
	Если Штабель.Количество()>0 Тогда 
		Список.Параметры.УстановитьЗначениеПараметра("ВсеШтабель", Ложь);
	Иначе
		Список.Параметры.УстановитьЗначениеПараметра("ВсеШтабель", Истина);
	КонецЕсли;
	
	Если Аддендум.Количество()>0 Тогда 
		Список.Параметры.УстановитьЗначениеПараметра("ВсеТекущийАддендум", Ложь);
	Иначе
		Список.Параметры.УстановитьЗначениеПараметра("ВсеТекущийАддендум", Истина);
	КонецЕсли;
