...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_Контрагент" Тогда
		Если ТекущийНомерСтраницы<>3 И ПараметрыФормы.СправочникКонтрагентовПустой Тогда
			СтратураПараметров = Новый Структура(ПараметрыФормы);
			СтратураПараметров.СправочникКонтрагентовПустой = Ложь;
			ПараметрыФормы = Новый ФиксированнаяСтруктура(СтратураПараметров);
		КонецЕсли; 
