...
&НаКлиенте
Процедура ПоступлениеОтКурьерскойКомпанииПочты(Команда)
	
	ДвиженияДенежныхСредствКлиент.СоздатьДокумент("ПоступлениеНаСчет", "ОтКурьерскойКомпанииПочты", ДанныеМеток, "БанковскиеВыписки");
