...
Процедура ДобавитьОтборыТеги(Построитель)
	...
	Для каждого Стр Из НаложенныеФильтры Цикл
		...
		// 20241122 Данько ТА Была не корректная работа отбора. Выводились все отчеты, где в наименование присутствует тег
		//а поиск должен осуществляться строго по тегу
		УстановитьОтборПостроителя(Построитель, "Теги", ВидСравнения.Содержит, Стр.Значение);
	КонецЦикла;
