...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбработкаНовостей.КонтекстныеНовости_ПриСозданииНаСервере(
		ЭтотОбъект,
		"УНФ.ОбщаяФорма.ПечатьДокументов",
		"ОбщаяФорма",
		Неопределено,
		НСтр("ru='Новости: Печать'"),
		Ложь,
...
Процедура Печать(Команда)
	...
	Если НастройкиПечатныхФорм.Количество()>0 тогда 
		...
		ТабличныеДокументы.Количество() > 1, ?(НастройкиПечатныхФорм[0].Количество > 1, Копий, 1));
	иначе 
		УправлениеПечатьюКлиент.РаспечататьТабличныеДокументы(ТабличныеДокументы, ОбъектыПечати,
