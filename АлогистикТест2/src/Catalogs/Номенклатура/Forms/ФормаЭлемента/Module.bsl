...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "Запись_ПрисоединенныйФайл" И Объект.ТипНоменклатуры = ПредопределенноеЗначение("Перечисление.ТипыНоменклатуры.Запас") Тогда
...
Процедура УправлениеФормой()
	...
	Элементы.ИспользоватьХарактеристики.Видимость = ЭтоЗапас() Или ЭтоУслуга() Или ЭтоРабота();
	Элементы.ИспользоватьПартии.Видимость = ЭтоЗапас();
	Элементы.ИспользоватьСерийныеНомера.Видимость = ЭтоЗапас();
	Элементы.НаправлениеДеятельности.Видимость = ЭтоЗапас() Или ЭтоУслуга() Или ЭтоРабота();
	Элементы.МетодОценки.Видимость = ЭтоЗапас();
	Элементы.СрокИсполненияЗаказа.Видимость = ЭтоЗапас() Или ЭтоУслуга() Или ЭтоРабота();
	Элементы.СтавкаНДС.Видимость = ЭтоЗапас() Или ЭтоУслуга() Или ЭтоРабота();
	Элементы.ПереключательСпособРасчетаСтоимости.Видимость = ЭтоРабота();
	
	// ГруппаАлкогольнаяПродукция
	Элементы.ГруппаАлкогольнаяПродукция.Видимость = ЭтоЗапас();
	...
	Элементы.Поставщик.Видимость = ЭтоЗапас() Или ЭтоУслуга();
	Элементы.СтранаПроисхождения.Видимость = ЭтоЗапас();
	Элементы.Спецификация.Видимость = ЭтоЗапас() Или ЭтоРабота();
	Элементы.СрокПополнения.Видимость = ЭтоЗапас();
	Элементы.НормаВремени.Видимость = ЭтоОперация();
	Элементы.ГарантийныйСрок.Видимость = ЭтоЗапас();
	Элементы.ВыписыватьГарантийныйТалон.Видимость = ЭтоЗапас();
	
	// ГруппаХранение
	Элементы.Склад.Видимость = ЭтоЗапас();
	Элементы.Ячейка.Видимость = ЭтоЗапас();
	...
	// ГруппаОбъемИВес
	Элементы.ГруппаОбъемИВес.Видимость = ЭтоЗапас();
