...
&НаКлиенте
// Процедура - обработчик события ПриИзменении поля ЗадаватьЗначениеПриРасчете.
//
Процедура ЗадаватьЗначениеПриРасчетеПриИзменении(Элемент)
	...
	Если Объект.ЗадаватьЗначениеПриРасчете Тогда
		...
		ПоказатьВопрос(Новый ОписаниеОповещения("ЗадаватьЗначениеПриРасчетеПриИзмененииЗавершение", ЭтотОбъект), ТекстСообщения, РежимДиалогаВопрос.ДаНет);
        Возврат;
