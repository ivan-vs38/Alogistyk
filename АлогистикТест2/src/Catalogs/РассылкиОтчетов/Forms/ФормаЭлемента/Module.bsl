...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//РФП ++
	НовыйЭлемент = ЭтаФорма.Элементы.Добавить("РФП_ОтправлятьВложенияОднойКнигой", Тип("ПолеФормы"),Элементы.ДополнительныеПараметры);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеФлажка;
	НовыйЭлемент.ПутьКДанным = "Объект.РФП_ОтправлятьВложенияОднойКнигой";
	//РФП --
