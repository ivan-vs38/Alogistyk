...
Процедура УправлениеСвойствомДоступность()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "Источник", "Доступность", НЕ Объект.ПроизвольныйЗапрос);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ПроизвольныйЗапрос", "Доступность", ПустаяСтрока(Объект.ИмяИсточника));
