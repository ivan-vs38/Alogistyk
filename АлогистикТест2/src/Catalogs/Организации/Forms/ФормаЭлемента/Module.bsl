...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Если ОткрытьНастройкиИспользованияФаксимиле Тогда
		
		ОткрытьНастройкиИспользованияФаксимиле = Ложь;
		ОткрытьНастройкиИспользованияФаксимиле();
		
	КонецЕсли;
	
	Если ИзменилиРуководителя
		ИЛИ ИзменилиГлавногоБухгалтера Тогда
...
Процедура ПодписьГлавногоБухгалтераПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Объект.Ссылка) Тогда
		...
		ИзменилиГлавныйБухгалтер = Истина;
...
&НаКлиенте
Процедура ОткрытьНастройкиИспользованияФаксимиле();
	
	ПараметрыОткрытия = Новый Структура;
	ПараметрыОткрытия.Вставить("Организация", Объект.Ссылка);
	
	ОткрытьФорму("РегистрСведений.ФаксимилеНастройки.ФормаСписка", ПараметрыОткрытия, ЭтаФорма);
	
КонецПроцедуры

&НаКлиенте
Процедура ПослеВопросПроЗаписьКарточки(Ответ, ДополнительныеПараметры) Экспорт
	
	Если Ответ = КодВозвратаДиалога.Да Тогда
		
		ОткрытьНастройкиИспользованияФаксимиле = Истина;
		Записать();
...
&НаКлиенте
Процедура ИспользованиеФаксимилеНажатие(Элемент)
	
	Если НЕ ЗначениеЗаполнено(Объект.Ссылка) Тогда
		
		ТекстВопроса = НСтр("ru ='Для просмотра настроек факсимиле необходимо записать организацию.
							|Записать и открыть настройки?'");
		
		ОписаниеОповещения = Новый ОписаниеОповещения("ПослеВопросПроЗаписьКарточки", ЭтотОбъект);
